				...
				<script type="text/javascript" src="<?php echo base_url() . "templates/architectui-html-free/"; ?>/assets/scripts/main.js"></script>
				</body>
				...
				<!-- sweet alert -->
				<!-- 
				<script src="<?php echo base_url() . "templates/"; ?>vendors/sweetalert/polyfills.js"></script>
				<script src="<?php echo base_url() . "templates/"; ?>vendors/sweetalert/sweetalert.js"></script>

            ...
            <div class="col py-1 px-3">
                <div class="input-group">
                    <div class="input-group-prepend">
                        <label class="input-group-text biz-bg-w-2 biz-border-w-2 lighten-3 biz-max-h-2_5" id="basic-text1" for="_bizSearch">
                            <i class="fas fa-search biz-fabiz-text-w-1 biz-text-1_5r"></i>
                        </label>
                    </div>
                    <input class="_bizSearch form-control form-search biz-no-focus biz-border-w-2 biz-bg-w-2 pl-0 biz-text-13 biz-max-h-2_5" type="text" placeholder="Search.." aria-label="Search" name="_bizSearch" id="_bizSearch">
                </div>
            </div>
        </div>
<?php
...
?>
            <div class="col">
                <button class="btn btn-block biz-no-shadow biz-text-13 no-text-transform biz-bg-w-2 biz-text-w-5 biz-rad-10 text-left px-3 py-2 _bizSelect" data-toggle="dropdown" data-value="default" id="btnSort">
...
?>
            <div class="col">
                <button class="btn btn-block biz-no-shadow biz-text-13 no-text-transform biz-bg-w-2 text-white biz-rad-10 text-left px-3 py-2 _bizSelect" data-toggle="dropdown" data-value="default" id="btnFilter">

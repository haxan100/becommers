...
<head>
	...
	<!-- //Custom Theme files -->
	<!-- font-awesome icons -->
	<link href="<?php echo base_url() . "templates/user/"; ?>css/font-awesome.css" rel="stylesheet">
	<!-- //font-awesome icons -->
	<!-- js -->
	<script src="<?php echo base_url() . "templates/user/"; ?>js/jquery.min.js"></script>
	<link rel="stylesheet" href="<?php echo base_url() . "templates/user/"; ?>css/jquery.countdown.css" /> <!-- countdown -->
	<!-- //js -->
	<!-- web fonts -->
